...
public class BumptestActivity extends Activity implements BumpAPIListener {
	private String chat;
	...
	public void onCreate(Bundle savedInstanceState) {
		...
		chatView = (TextView) findViewById(R.id.editText2);
	...
	public void onConnectButton(View v) {
		...
		bump.putExtra(BumpAPI.EXTRA_API_KEY, "YOUR_API_KEY");
